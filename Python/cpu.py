...
class CPU:
    ...
    def stackPeekWord(self, pos):
        vl = self.mmu.read(self.stack_page*0x100 + ((self.r.s + pos) & 0xff))
        vh = self.mmu.read(self.stack_page*0x100 + ((self.r.s + pos+1) & 0xff))
        return (vh <<8) + vl
    
    def stackPeekByte(self, pos):
        return self.mmu.read(self.stack_page*0x100 + ((self.r.s + pos) & 0xff))
